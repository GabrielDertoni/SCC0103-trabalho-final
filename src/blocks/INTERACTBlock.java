...
public class INTERACTBlock extends BaseBlock {
	...
	public INTERACTBlock(BaseBlock father, BlockEditor editor, int posX, int posY, int index) {
		super(father, editor, posX, posY, 450, 80, BaseBlock.Mode.DRAGGABLE_Y, index, "src/blocks/INTERACTPlaceHolder.png");
